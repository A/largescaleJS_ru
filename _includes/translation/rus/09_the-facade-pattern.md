...
кода, скрывая их истинную сложность. Относитесь к фасаду, как
...
ничего не зная о подсистемах, которые скрываются за ним.
...
библиотеки на другую не меняя слой взаимодействия — например, с jQuery на dojo.
