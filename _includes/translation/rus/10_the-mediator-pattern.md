...
Уменьшает связывание модулей путем добавления посредника — центрального
элемента управления, что позволяет модулям отправлять и слушать сообщения
...
головные боли. Часто решинием этих проблем заключается в уменьшении связанности.
...
**Пример:** А это два примера использования реализации, написанной выше. 
Это эффективное управление публикацией собщений и подпиской на них:
