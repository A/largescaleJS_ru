...
вам DOM-элементы используя jQuery (или dojo). Таким образом модули все еще могут
...
(разаблачу себя: деньги от этой реферальной ссылки, как и любые другие, полученные
от этой книги в пересмотр материала перед тем, как я порекоммендую его другим).
...
используется слово «песочница», как у Николоса Закас. Так же, здесь есть
обсуждение о том, что работа с DOM-библиотеками, в идеале, должа быть реализованна
посредством абстстракции. Я говорил об этом в предыдущем вопросе. Тут Эндрю
делает ставку на некоторые интересные шаблоны, обобщающие работу с селекторами
DOM, таким образом, в крайнем случае, замена библиотеки может быть выполненна
в нескольких коротких строках. Я не говорю, что это лучший или самый правильный
...
модулям напрямую обращаться к ядру. Это скорее относится к best practices.
