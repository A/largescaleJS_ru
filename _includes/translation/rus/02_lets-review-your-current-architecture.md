...
количество времени** на планирование изначальной архитектуры, к которой очень
чувствительны приложения подобного рода. Большие приложения обычно представляют
из себя очень сложные системы, гораздо более сложные, чем вы их представляете
себе изначально.
...
проекте среднего масштаба. Думаю, они точно сработают и для чем-то большего,
...
немного доводов о том, почему вам стоит уделить немного больше времени
...
### 1. Готова ли ваша архитектура прямо сейчас к переиспользованию кода?

Могут ли отдельные модули использоваться самостоятельно? Являются ли они
достаточно автономными? Мог бы я прямо сейчас взять один из модулей вашего большого 
...
email-клиенте, почнму бы нам не добавить этот модуль к нашему новому приложению для
